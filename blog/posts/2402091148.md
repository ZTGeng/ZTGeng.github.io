...
做好之后就放到了网上，在一个叫 [HuggingFace](https://huggingface.co/spaces/ztgeng/ChatGPT-Face) 的网站的免费虚拟机上跑了起来。这台 2 vCPU 16G 内存没有显卡的虚拟机跑这个 36M 参数的神经网络十分勉强。后端收到请求，花几秒等 ChatGPT 回复，花二十来秒等 TextToSpeech 回复，再花两分钟等神经网络生成视频。用户发完消息要枯等两三分钟，看着一个加载提示图标转转转，体验D差。
